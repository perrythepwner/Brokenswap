...
export declare class LedgerWallet extends RemoteWallet<LedgerSigner> implements ReadOnlyWallet {
    ...
    protected loadAccountSigners(): Promise<Map<Address, LedgerSigner>>;
