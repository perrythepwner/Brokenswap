      ...
      <ModalContentWrapper>
        <AutoColumn gap="lg">
          ...
          <AutoColumn gap="lg" style={{ padding: '0 2rem' }}>
            ...
            <RowBetween>
              <ButtonSecondary mr="0.5rem" padding="18px" onClick={onDismiss}>{`${'Cancel'}`}</ButtonSecondary>
              <ButtonPrimary borderRadius="12px" onClick={onConfirm}>{`${'Continue'}`}</ButtonPrimary>
            </RowBetween>
          </AutoColumn>
        </AutoColumn>
      </ModalContentWrapper>
