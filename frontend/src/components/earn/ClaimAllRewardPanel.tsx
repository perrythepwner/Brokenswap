      ...
      <TopBorderCard>
        <CardSection>
          <RowStart>
            ...
            <AutoColumn gap="md">
              <RowCenter>
                <TYPE.black fontWeight={600}>You have unclaimed rewards: {contracts?.length}</TYPE.black>
              </RowCenter>
              {pending && (
                <RowCenter>
              ...
              {!pending && <StyledLink onClick={onClaimRewards}>{'Claim all rewards'}</StyledLink>}
            </AutoColumn>
          </RowStart>
        </CardSection>
      </TopBorderCard>
