...
interface RomulusDelegatorInterface extends ethers.utils.Interface {
  functions: {
...
export class RomulusDelegator extends BaseContract {
  ...
  interface: RomulusDelegatorInterface;
  ...
  functions: {
    ...
    resolve(name: BytesLike, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    resolve(name: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
