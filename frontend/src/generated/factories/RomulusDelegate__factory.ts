...
import type {
  RomulusDelegate,
  RomulusDelegateInterface,
} from "../RomulusDelegate";
...
export class RomulusDelegate__factory {
  static readonly abi = _abi;
  static createInterface(): RomulusDelegateInterface {
    return new utils.Interface(_abi) as RomulusDelegateInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RomulusDelegate {
    return new Contract(address, _abi, signerOrProvider) as RomulusDelegate;
  }
}
