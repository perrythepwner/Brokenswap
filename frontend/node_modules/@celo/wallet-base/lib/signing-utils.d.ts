...
import { CeloTx, EncodedTransaction, Hex, RLPEncodedTx } from '@celo/connect';
...
export declare function stringNumberOrBNToHex(num?: number | string | ReturnType<Web3['utils']['toBN']>): Hex;
...
export declare function getSignerFromTxCIP42(serializedTransaction: string): string;
