...
interface UbeswapMoolaRouterBaseInterface extends ethers.utils.Interface {
  functions: {
...
export class UbeswapMoolaRouterBase extends Contract {
  ...
  interface: UbeswapMoolaRouterBaseInterface;
