...
interface UbeswapMoolaRouterInterface extends ethers.utils.Interface {
  functions: {
    "MOOLA_ROUTER_REFERRAL_CODE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MOOLA_ROUTER_REFERRAL_CODE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class UbeswapMoolaRouter extends Contract {
  ...
  functions: {
    MOOLA_ROUTER_REFERRAL_CODE(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    MOOLA_ROUTER_REFERRAL_CODE(overrides?: CallOverrides): Promise<BigNumber>;
